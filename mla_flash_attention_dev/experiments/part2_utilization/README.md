...
```bash
python3 mla_flash_attention_dev/experiments/part2_utilization/build_part2_results.py
```
...
- `mla_flash_attention_dev/experiments/profiling/profile_deepseek_flash_mla_part2.py`
  - 很薄的 child-run 执行器
  - 负责执行单个 `TT / DeepSeek-4c / DeepSeek-8c` decode 代表点
- `mla_flash_attention_dev/experiments/profiling/run_deepseek_flash_mla_part2_probe.py`
  - sweep runner
...
```bash
python3 mla_flash_attention_dev/experiments/profiling/profile_deepseek_flash_mla_part2.py --list-preset-cases
```
...
```bash
python3 mla_flash_attention_dev/experiments/profiling/run_deepseek_flash_mla_part2_probe.py --minimal --dry-run
```
...
```bash
python3 mla_flash_attention_dev/experiments/profiling/run_deepseek_flash_mla_part2_probe.py --groups D --variants tt deepseek4c deepseek8c --dry-run
```
