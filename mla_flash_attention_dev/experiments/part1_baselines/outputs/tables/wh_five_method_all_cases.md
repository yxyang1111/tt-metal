...
说明：如果想看五种方法各自的实现入口、数据形态、reader/compute/writer 数据流、4c/8c 几何差异与中间结果流向，见 `mla_flash_attention_dev/experiments/part1_baselines/five-method-dataflow-analysis.md`；快速版先看该文档的 `第 0 节`。
