...
- `decode_8k`: DeepSeek = `avg 0.438 / best 0.407 / worst 0.521 ms (10/10 kept)`，平均吞吐量 = `~2282.7 tok/s`，相对 Flash = `~0.93x`，相对 TT 主线 FlashMLA = `~0.97x`。
...
- Decode batch sweep 时延图：`multidim/visuals/decode_batch_sweep_latency.svg`
