...
| DeepSeek parallelism policy | `fixed` | `fixed`=固定 q_heads_per_core；`align_with_tt_mainline`=按 TT 主线并行度派生 |
| device_id | `0` | TT 设备编号 |
| arch | `wormhole_b0` | 当前结果中的设备架构 |
| compute grid | `8 x 7` | 当前结果中的 `compute_with_storage_grid_size` |
| total configs | `4` | 当前主跑实际生成的 config 数量 |
| default config | `b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc8` | 默认主表固定使用的 config |
| default config label | `B=1, H=16, H_kv=1, value_dim=512, rope_dim=64, block=64, k_chunk=128, deepseek_q_heads_per_core=8` | 默认主表的人类可读说明 |
...
|---|---|---|
| `B` | `1` | 主跑 batch sweep |
| `H` | `16` | 主跑 num_heads sweep |
| `H_kv` | `1` | 主跑 num_kv_heads sweep |
| `value_dim` | `512` | 严格四方法公共 value dim sweep |
| `rope_dim` | `64` | rope dim sweep |
| `deepseek_num_q_heads_per_core` | `1, 2, 4, 8` | DeepSeek Q shard 粒度 sweep / 派生结果 |
...
|---|---:|---|
| `batch` | `1` | 默认主表 batch |
| `num_heads` | `16` | 默认主表 attention heads |
...
| 项目 | 当前值 | 说明 |
|---|---|---|
| decode q_num_cores | `16` | TT 主线 decode 默认 `q_num_cores=min(B*H, grid_x*grid_y)` |
| DeepSeek num_q_shards | `2` | `num_heads / deepseek_num_q_heads_per_core` |
| DeepSeek required q cores | `2` | 当前 builder 使用 `batch * num_q_shards` 个活跃核 |
...
| 参数 | 当前值 | 说明 |
|---|---|---|
| `--cases` | `decode_256_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_512_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_1k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_2k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_4k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_8k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_16k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_32k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_64k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_128k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, prefill_1k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, prefill_4k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc1, decode_256_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_512_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_1k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_2k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_4k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_8k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_16k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_32k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_64k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_128k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, prefill_1k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, prefill_4k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc2, decode_256_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_512_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_1k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_2k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_4k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_8k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_16k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_32k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_64k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_128k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, prefill_1k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, prefill_4k_b1_h16_hkv1_dv512_ro64_blk64_kc128_dqhpc4, decode_256, decode_512, decode_1k, decode_2k, decode_4k, decode_8k, decode_16k, decode_32k, decode_64k, decode_128k, prefill_1k, prefill_4k` | 本次实际运行的 benchmark cases |
...
- Detailed profile 来源：`/rshome/yuxin.yang/dev/tt-metal/mla_flash_attention_dev/experiments/profiling/outputs/flash_mla_wh_detailed`
