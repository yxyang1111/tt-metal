...
- **S-FMLA**: Wormhole 上优化的 sparse flash MLA 实现（本报告主要 baseline；默认使用修正后的 decode/prefill latency）
...
- FlashMLA / S-FMLA: median=1.263x, mean=1.246x, min=0.844x, max=1.608x
- FlashMLA 快于 S-FMLA 的配置: 5/59 (8.5%)
- MLA baseline / S-FMLA: median=32.6x, max=174.7x
- L40S/3 vs S-FMLA: median ratio=0.493x; S-FMLA 更快于 L40S/3 的配置: 14/59 (23.7%)

### Prefill
- 有效 S-FMLA 测点: 28；FlashMLA 有效: 28；两者同时有效: 28
- FlashMLA / S-FMLA: median=2.037x, mean=1.975x, min=1.034x, max=2.435x
- FlashMLA 快于 S-FMLA 的配置: 0/28 (0.0%)
- MLA baseline / S-FMLA: median=4.4x, max=6.3x
- L40S/3 vs S-FMLA: median ratio=0.989x; S-FMLA 更快于 L40S/3 的配置: 13/28 (46.4%)

### Decode — S-FMLA 快于 L40S/3 的 Top 5 配置
(ratio = L40S/3 ÷ S-FMLA，>1 表示 S-FMLA 更快)

- B=16, L=32K: S-FMLA=1.369ms, ratio=2.430x
- B=16, L=128K: S-FMLA=7.466ms, ratio=2.225x
- B=16, L=64K: S-FMLA=3.933ms, ratio=2.077x
- B=32, L=32K: S-FMLA=3.160ms, ratio=1.885x
...
- B=1, L=32K: S-FMLA=0.871ms, ratio=0.263x
- B=2, L=128K: S-FMLA=4.484ms, ratio=0.297x
- B=2, L=64K: S-FMLA=2.348ms, ratio=0.305x
...
- B=1, L=256: ratio=7.46x
- B=2, L=256: ratio=5.34x
- B=1, L=512: ratio=4.45x