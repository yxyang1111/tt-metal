...
- `mla_flash_attention_dev/experiments/part1_three_baselines/run_part1_benchmarks.py`
...
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_probe_4c_b8_h32_s8k/raw/capability_probe_results.json`
...
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_probe_8c_b8_h32_s8k/raw/capability_probe_results.json`
...
python mla_flash_attention_dev/experiments/part1_three_baselines/run_part1_benchmarks.py \
  --cases decode_8k \
  --batches 8 \
  --num-heads-list 32 \
  --num-kv-heads-list 1 \
...
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_bench_8c_b8_h32_s8k/raw/part1_four_method_results.json`
...
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_batchsweep_4c_h32_s8k/raw/part1_four_method_results.json`
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_batchsweep_8c_h32_s8k/raw/part1_four_method_results.json`
- 汇总表：`mla_flash_attention_dev/experiments/part1_three_baselines/outputs/tables/wh_4c_vs_8c_batch_summary.md`
...
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_headsweep_4c_b8_s8k/raw/part1_four_method_results.json`
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_headsweep_8c_b8_s8k/raw/part1_four_method_results.json`
- 汇总表：`mla_flash_attention_dev/experiments/part1_three_baselines/outputs/tables/wh_4c_vs_8c_head_summary.md`
...
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_seqsweep_4c_b8_h24/raw/part1_four_method_results.json`
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_seqsweep_8c_b8_h24/raw/part1_four_method_results.json`
- 汇总表：`mla_flash_attention_dev/experiments/part1_three_baselines/outputs/tables/wh_4c_vs_8c_seq_summary.md`
...
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_qshard4_seqsweep_4c_b6_h32/raw/part1_four_method_results.json`
- `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_qshard4_seqsweep_8c_b6_h32/raw/part1_four_method_results.json`
- 汇总表：`mla_flash_attention_dev/experiments/part1_three_baselines/outputs/tables/wh_4c_vs_8c_qshard4_seq_summary.md`
- `4k` 复测：
  - `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_qshard4_seq4k_recheck_4c_b6_h32/raw/part1_four_method_results.json`
  - `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_qshard4_seq4k_recheck_8c_b6_h32/raw/part1_four_method_results.json`
- `4k` 高迭代稳定性检查：
  - `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_qshard4_seq4k_stability10_4c_b6_h32/raw/part1_four_method_results.json`
  - `mla_flash_attention_dev/experiments/part1_three_baselines/outputs_wh8_qshard4_seq4k_stability10_8c_b6_h32/raw/part1_four_method_results.json`
