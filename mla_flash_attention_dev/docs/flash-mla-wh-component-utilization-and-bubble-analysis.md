...
- 同步代表点 source-level / direct PM 补充：
  - `mla_flash_attention_dev/experiments/profile_outputs/flash_mla_pm_bubble_probe_sync_smoke/`
  - `mla_flash_attention_dev/experiments/profile_outputs/flash_mla_pm_bubble_probe_repr_sync/`
  - `mla_flash_attention_dev/experiments/profile_outputs/flash_mla_pm_bubble_probe_sync_extra/`
